...
- `ALLOWED_ORIGINS=*` оставлен до получения окончательного адреса GitHub Pages. После публикации панели заменить `*` на точный адрес вида `https://имя.github.io`.

## Первый запуск

1. Загрузить содержимое папки v70 в GitHub.
