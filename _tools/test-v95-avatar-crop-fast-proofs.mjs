...
assert.match(index,/TEST v95 · Avatar crop and fast proof viewer/);
assert.match(index,/modular-v95-avatar-crop-fast-proofs/);
assert.ok(index.indexOf('js/config/google-drive.js?v=95')<index.indexOf('js/services/google-drive-storage.js?v=95'));
assert.ok(index.indexOf('js/services/google-drive-storage.js?v=95')<index.indexOf('js/app.js?v=95'));
assert.ok(index.indexOf('js/app.js?v=95')<index.indexOf('js/features/google-drive-avatar.js?v=95'));
assert.match(mainCss,/features\/google-drive-avatar\.css\?v=95/);
...
assert.match(reportHtml,/js\/config\/google-drive\.js\?v=95/);
...
assert.deepEqual(versionHeadings,['95','94','93']);
assert.match(readme,/Папки `proof-service` в v95 больше нет/);
...
console.log('RP CABINET v95 avatar crop, fast proofs, viewer, Drive and realtime tests: OK');
