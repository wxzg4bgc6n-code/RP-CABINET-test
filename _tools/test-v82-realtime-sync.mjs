...
assert.match(index,/realtime-state\.js\?v=82/);
assert.match(index,/TEST v82 · Collapsible proof galleries/);
...
console.log('RP CABINET v82 realtime synchronization and collapsible proof gallery tests: OK');
