...
assert.match(index,/realtime-state\.js\?v=81/);
assert.match(index,/TEST v81 · Profile sync loader/);
assert.match(index,/class="profile-boot-screen"/);
assert.match(app,/classList\.add\('profile-boot-leaving'\)/);

console.log('RP CABINET v81 realtime synchronization and loader tests: OK');
