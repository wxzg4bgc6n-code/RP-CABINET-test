...
assert.match(index,/realtime-state\.js\?v=89/);
assert.match(index,/TEST v89 · smart context search/);
...
assert.match(reportHtml,/report\.js\?v=89/);
...
assert.deepEqual(readmeVersions,[89,88,87]);
...
assert.ok(index.indexOf('data/usaf/law-guide.js?v=89')>index.indexOf('data/usaf/content.js?v=89'));
assert.ok(index.indexOf('data/usaf/law-guide.js?v=89')<index.indexOf('data/usaf/tests.js?v=89'));
...
console.log('RP CABINET v89 regression, report avatar and realtime tests: OK');
