...
assert.match(index,/TEST v97 · Proof cleanup and bulk delete/);
assert.match(index,/modular-v97-proof-cleanup/);
assert.ok(index.indexOf('js/config/google-drive.js?v=97')<index.indexOf('js/services/google-drive-storage.js?v=97'));
assert.ok(index.indexOf('js/services/google-drive-storage.js?v=97')<index.indexOf('js/app.js?v=97'));
assert.ok(index.indexOf('js/app.js?v=97')<index.indexOf('js/features/google-drive-avatar.js?v=97'));
assert.match(mainCss,/features\/google-drive-avatar\.css\?v=97/);
...
assert.match(reportHtml,/js\/config\/google-drive\.js\?v=97/);
...
assert.deepEqual(versionHeadings,['97','96','95']);
assert.match(readme,/Папки `proof-service` в v97 больше нет/);
...
console.log('RP CABINET v97 proof cleanup, bulk delete, Drive and realtime tests: OK');
