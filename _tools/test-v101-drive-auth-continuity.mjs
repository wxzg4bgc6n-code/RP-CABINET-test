...
assert.match(index,/TEST v101 · Drive authorization continuity/);
assert.match(index,/modular-v101-drive-auth-continuity/);
assert.ok(index.indexOf('js/config/google-drive.js?v=101')<index.indexOf('js/services/google-drive-storage.js?v=101'));
assert.ok(index.indexOf('js/services/google-drive-storage.js?v=101')<index.indexOf('js/app.js?v=101'));
assert.ok(index.indexOf('js/app.js?v=101')<index.indexOf('js/features/google-drive-avatar.js?v=101'));
assert.match(mainCss,/features\/google-drive-avatar\.css\?v=101/);
assert.ok(index.indexOf('data/usaf/law-data.js?v=101')<index.indexOf('data/usaf/law-guide.js?v=101'));
assert.ok(index.indexOf('data/usaf/tests.js?v=101')<index.indexOf('data/usaf/law-exam.js?v=101'));
...
assert.match(reportHtml,/js\/config\/google-drive\.js\?v=101/);
...
assert.deepEqual(versionHeadings,['101','100','99']);
assert.match(readme,/Папки `proof-service` в v101 нет/);
...
console.log('RP CABINET v101 Drive authorization continuity, USAF exam and realtime tests: OK');
