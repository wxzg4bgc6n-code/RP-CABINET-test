...
assert.match(index,/realtime-state\.js\?v=83/);
assert.match(index,/TEST v83 · USAF law field guide/);
...
// Памятка УАК/ПК добавляется после основного USAF-контента и остаётся последним разделом.
...
assert.ok(usafMarkup.lastIndexOf('id="usaf-law"')>usafMarkup.lastIndexOf('id="usaf-speech"'));
...
assert.ok(index.indexOf('data/usaf/law-guide.js?v=83')>index.indexOf('data/usaf/content.js?v=83'));
assert.ok(index.indexOf('data/usaf/law-guide.js?v=83')<index.indexOf('data/usaf/tests.js?v=83'));

console.log('RP CABINET v83 realtime sync, proof galleries and USAF law guide tests: OK');
