...
assert.match(index,/TEST v93 · Google Drive proofs and avatars/);
assert.match(index,/modular-v93-google-drive-storage/);
assert.ok(index.indexOf('js/config/google-drive.js?v=93')<index.indexOf('js/services/google-drive-storage.js?v=93'));
assert.ok(index.indexOf('js/services/google-drive-storage.js?v=93')<index.indexOf('js/app.js?v=93'));
assert.ok(index.indexOf('js/app.js?v=93')<index.indexOf('js/features/google-drive-avatar.js?v=93'));
assert.match(mainCss,/features\/google-drive-avatar\.css\?v=93/);
...
assert.match(reportHtml,/js\/config\/google-drive\.js\?v=93/);
...
assert.deepEqual(versionHeadings,['93','92','91']);
assert.match(readme,/Папки `proof-service` в v93 больше нет/);
...
console.log('RP CABINET v93 Google Drive storage, public report, avatar and realtime tests: OK');
