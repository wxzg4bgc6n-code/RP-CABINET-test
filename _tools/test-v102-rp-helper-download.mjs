...
assert.match(index,/TEST v102 · RP-Helper download/);
assert.match(index,/modular-v102-rp-helper-download/);
assert.ok(index.indexOf('js/config/google-drive.js?v=102')<index.indexOf('js/services/google-drive-storage.js?v=102'));
assert.ok(index.indexOf('js/services/google-drive-storage.js?v=102')<index.indexOf('js/app.js?v=102'));
assert.ok(index.indexOf('js/app.js?v=102')<index.indexOf('js/features/google-drive-avatar.js?v=102'));
assert.match(mainCss,/features\/google-drive-avatar\.css\?v=102/);
assert.ok(index.indexOf('data/usaf/law-data.js?v=102')<index.indexOf('data/usaf/law-guide.js?v=102'));
assert.ok(index.indexOf('data/usaf/tests.js?v=102')<index.indexOf('data/usaf/law-exam.js?v=102'));
...
assert.match(reportHtml,/js\/config\/google-drive\.js\?v=102/);
...
assert.deepEqual(versionHeadings,['102','101','100']);
assert.match(readme,/Папки `proof-service` в v102 нет/);
...
console.log('RP CABINET v102 RP-Helper download, USAF exam and realtime tests: OK');
