/* v92: практическая памятка УАК/ПК для USAF. */
  ...
  <details class="section-toggle academy-expand-card">
    ...
    <div class="academy-expand-content usaf-expand-content usaf-law-content-v92">
      <div class="usaf-law-board-v92">
        ...
        <footer class="usaf-law-footer-v92"><strong>Перед самой сдачей</strong><p>Перепроверь номера статей по текущим редакциям УАК и ПК своего сервера: формулировки и нумерация меняются. Эта памятка учит правильной логике USAF и не заменяет полный текст законодательства.</p></footer>
      </div>
    </div>
  </details>
</section>`;
