      ...
      <div class="usaf-law-board-v92">
        ...
        <section class="usaf-law-group-v92 usaf-law-exam-summary-v98" aria-labelledby="usaf-law-exam-summary-v98">
          ...
          <div class="usaf-law-exam-mini-v98">
            ...
            <p><b>Миранда:</b> разъясни права дважды либо до подтверждения ознакомления. Формулировка должна полностью и понятно передавать права задержанного.</p>
            <p><b>Звонок и адвокат:</b> задержанный вправе запросить их не позднее одной минуты после прибытия в ближайшее КПЗ, полицейское управление, офис FIB или блок оформления Федеральной тюрьмы.</p>
            ...
            <p><b>Военная служба по форме экзамена:</b> 18.2 — 4 месяца; 18.3 — 6 месяцев лишения свободы.</p>
          </div>
        </section>
        ...
        <section class="usaf-law-group-v92" aria-labelledby="usaf-law-project-rules-v108">
          <header class="usaf-law-group-head-v92"><h3 id="usaf-law-project-rules-v108">Правила гос. фракций: важное для ARMY</h3></header>
          <div class="usaf-law-split-v92">
          ...
          <div class="usaf-law-call-notes-v92">
            <p><b>Ammunation:</b> ARMY / USAF больше не участвует в отбитии. Со стороны государственных структур допускаются только FIB, LSPD и LSSD.</p>
            <p><b>Поезд:</b> это изменение Ammunation не отменяет защиту поезда; в правилах нападения на поезд отдельно предусмотрен перехват машины представителями силовых структур.</p>
          </div>
        </section>

        <section class="usaf-law-group-v92" aria-labelledby="usaf-law-evidence-v108">
          <header class="usaf-law-group-head-v92"><h3 id="usaf-law-evidence-v108">Уголовные дела: требования к уликам</h3></header>
          <div class="usaf-law-fact-grid-v92">
            ...
            <article class="usaf-law-fact-v92"><strong>От начала до конца</strong><h4>Целая ситуация</h4><p>Улика должна показывать ситуацию полностью — от начала до фактического завершения. Обрезанный отдельный фрагмент не принимается.</p></article>
            <article class="usaf-law-fact-v92"><strong>Без 45 сек.</strong><h4>Старый лимит удалён</h4><p>Отдельное правило «улики меньше 45 секунд не принимаются» удалено. Критерий теперь — полнота ситуации.</p></article>
          </div>
          <div class="usaf-law-call-notes-v92">
            <p><b>Монтаж:</b> улика не должна подвергаться видеомонтажу. Исключение — записи с голосом или видео человека, дающего показания (осведомителя).</p>
            <p><b>Перед рейдом:</b> для получения ордера необходимо отыграть передачу дела сотруднику прокуратуры и иметь видео/фотофиксацию для администрации.</p>
          </div>
        </section>

        <section class="usaf-law-group-v92" aria-labelledby="usaf-law-interrogation-v108">
          <header class="usaf-law-group-head-v92"><h3 id="usaf-law-interrogation-v108">Допросы: не путать два режима</h3></header>
