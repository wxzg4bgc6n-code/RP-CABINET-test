/* v98: практическая памятка УАК/ПК для USAF и связанный экзамен. */
  ...
  <details class="section-toggle academy-expand-card">
    ...
    <div class="academy-expand-content usaf-expand-content usaf-law-content-v92">
      <div class="usaf-law-board-v92">
        <aside class="usaf-law-warning-v92">
        ...
        <section class="usaf-law-group-v92 usaf-law-exam-summary-v98" aria-labelledby="usaf-law-exam-summary-v98">
          <header class="usaf-law-group-head-v92"><h3 id="usaf-law-exam-summary-v98">Коротко по вопросам экзамена</h3></header>
          <div class="usaf-law-exam-facts-v98">
            <article><strong>1 час</strong><span>Максимальный срок задержания до применения меры наказания по набору экзамена.</span></article>
            <article><strong>72 часа</strong><span>Срок хранения видеозаписи процессуальных действий.</span></article>
            <article><strong>7 пунктов</strong><span>Тактическое подразделение выполняет первые семь пунктов и передаёт задержанного.</span></article>
            <article><strong>Удостоверение</strong><span>После ограничения свободы, но до разъяснения сути деяния.</span></article>
            <article><strong>Региональная</strong><span>В рацию департамента запрашиваются LSPD/LSSD.</span></article>
            <article><strong>Федеральная</strong><span>В рацию департамента запрашивается FIB.</span></article>
            <article><strong>Общая</strong><span>До 6 месяцев — LSPD/LSSD; свыше 6 месяцев — FIB.</span></article>
            <article><strong>Госслужащий</strong><span>Решение выносит прокурор, а при его отсутствии — вышестоящее руководство задержанного.</span></article>
          </div>
          <div class="usaf-law-exam-mini-v98">
            <p><b>Освободить:</b> вина не установлена; арест за деяние не предусмотрен; истёк процессуальный час без применения ареста.</p>
            <p><b>Не является основанием:</b> отказ подозреваемого давать показания.</p>
            <p><b>Миранда:</b> в наборе экзамена выбирается вариант о кратком перечислении прав; смысл прав должен быть передан полностью и понятно.</p>
            <p><b>Ключевые статьи:</b> 12.7.2 — проникновение на ФЗ/ФТ; 12.8 — незаконный оборот оружия; 17.1 — нападение на государственного сотрудника.</p>
          </div>
        </section>
        ...
        <section class="usaf-law-group-v92" aria-labelledby="usaf-law-flow-v92">
          <header class="usaf-law-group-head-v92"><h3 id="usaf-law-flow-v92">Алгоритм обычного бойца USAF</h3></header>
          <ol class="usaf-law-flow-v92">
        ...
        <section class="usaf-law-group-v92" aria-labelledby="usaf-law-cases-v92">
          ...
          <p class="usaf-law-study-note-v92">Для каждой темы отдельно выучи по актуальному УАК: номер статьи, краткое название, состав нарушения и наказание. Номера в памятку намеренно не зашиты — редакции законодательства на серверах меняются.</p>
        </section>

        <section class="usaf-law-group-v92" aria-labelledby="usaf-law-qa-v92">
          <header class="usaf-law-group-head-v92"><h3 id="usaf-law-qa-v92">Важные вопросы для сдачи</h3></header>
          <div class="usaf-law-qa-v92">
        ...
        <footer class="usaf-law-footer-v92"><strong>Перед самой сдачей</strong><p>Экзаменационный блок повторяет все присланные вопросы и варианты без сокращения. Для реальных процессуальных действий дополнительно проверяй действующие редакции УАК и ПК своего сервера: формулировки, сроки и наказания могут обновляться.</p></footer>
      </div>
    </div>
  </details>
</section>`;
